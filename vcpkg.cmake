...
function (find_vcpkg)
    ...
    execute_process(COMMAND ${FIND_PROGRAM_COMMAND} vcpkg ERROR_VARIABLE cmd_error OUTPUT_VARIABLE cmd_output)
    if (NOT cmd_error)
...
function (vcpkg_install_library library_name)
    if(NOT DEFINED ENV{VCPKG_PATH})
        message(STATUS "VCPKG not yet found trying to find it now!")
        find_vcpkg()
    endif()
    message(STATUS "Installing library ${library_name} with $ENV{VCPKG_PATH}")
    execute_process(COMMAND $ENV{VCPKG_PATH} install ${library_name})
endfunction()